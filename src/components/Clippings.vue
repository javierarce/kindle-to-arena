      ...
      <div class="Clippings__header">
        ...
        <div class="Clippings__actions">
          ...
          <div class="Collaborate" v-if="false && selectedChannel">
            ...
            <div class="Tooltip">?  <span class="Tooltip__text"><strong>(BETA)</strong> Checking the box will grant you access as collaborator of the Clippings shared channel and share your highlight there.</span></div>
          </div>
          </transition>
...
export default {
  ...
  methods: {
    ...
    onClickAuth (e) {
      this.saveItemToLocalStorage('selected_book', { id: this.book.id, title: this.book.title })
      window.open('/auth/arena', '_self')
    },
    onClickSend (e) {
      if (!this.canSend()) {
        return
